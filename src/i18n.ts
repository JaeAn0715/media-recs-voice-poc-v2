...
const ko = {
  ...
  clearRecommendations: '최근 추천목록 전부 지우기',
  clearRecommendationsConfirm: '저장된 추천목록을 모두 지울까요?',
  ...
  noMusicSearchValue: '음성에서 곡명이나 아티스트명을 찾을 수 없습니다. 다시 말씀해 주세요.',
...
const en: Record<keyof typeof ko, string> = {
  ...
  clearRecommendationsConfirm: 'Clear all saved recommendations?',
  ...
  noMusicSearchValue: 'No song title or artist found in the request. Please try again.',
