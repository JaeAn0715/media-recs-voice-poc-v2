import type { Line } from '../data/transitNetwork'
import { normalizeStation } from '../data/transitNetwork'
...
export const findNextTrain = (
  ...
  return candidates.sort(
    (a, b) => Number(a.barvlDt ?? Number.MAX_SAFE_INTEGER) - Number(b.barvlDt ?? Number.MAX_SAFE_INTEGER),
  )[0]
}
